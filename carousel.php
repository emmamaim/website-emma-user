<div class="container">
    <div class="row g-4">
        ...
        <div class="col-12 col-md-6">
            <!-- 建立廣告輪播carousel資料查詢 -->
            <?php
            $SQLstring = "SELECT * FROM carousel WHERE carousel_id = 1 AND caro_online = 1 order by caro_sort";
            ...
            <div id="carouselExampleCaptions1" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-indicators">
                    <?php for ($i = 0; $i < $carousel->rowCount(); $i++) { ?>
                        <button type="button" data-bs-target="#carouselExampleCaptions1" data-bs-slide-to="<?php echo $i; ?>" class="<?php echo activeShow($i, 0); ?>" aria-current="true" aria-label="Slide <?php echo $i; ?>">
                        </button>
                    <?php } ?>
                </div>
        ...
        <div class="col-12 col-md-6">
            <!-- 建立廣告輪播carousel資料查詢 -->
            <?php
            $SQLstring = "SELECT * FROM carousel WHERE carousel_id = 2 AND caro_online = 1 order by caro_sort";
            $carousel = $link->query($SQLstring);
            $i = 0; // 控制active
            ?>
            <div id="carouselExampleCaptions2" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-indicators">
                    <?php for ($i = 0; $i < $carousel->rowCount(); $i++) { ?>
                        <button type="button" data-bs-target="#carouselExampleCaptions2" data-bs-slide-to="<?php echo $i; ?>" class="<?php echo activeShow($i, 0); ?>" aria-current="true" aria-label="Slide <?php echo $i; ?>">
                        </button>
                    <?php } ?>
                </div>
                <div class="carousel-inner">
