...
<?php if ($cart_rs->rowCount() != 0) { ?>
    ...
    <div class="table-responsive-md">
        <table class="table table-hover mt-3">
            ...
            <tbody>
                <?php while ($cart_data = $cart_rs->fetch()) { ?>
                    <tr>
                        ...
                        <td>
                            <button type="button" id="btn[]" name="btn[]" class="btn btn-danger" onclick="btn_confirmLink('確定刪除本資料?','shopcart_del.php?mode=1&cartid=<?php echo $cart_data['cartid']; ?>');">取消</button>
                        </td>
                    </tr>
            ...
            <tfoot>
                <tr>
                    <td colspan="7">纍計：<?php echo $ptotal; ?></td>
                </tr>
                <tr>
